...
<template>
  <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
    <div v-for="dc in cards" :key="dc.cardId" class="relative group">
      ...
      <button
        class="absolute bottom-1 right-1 bg-black/60 text-white rounded-full w-5 h-5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
        title="更換圖片"
